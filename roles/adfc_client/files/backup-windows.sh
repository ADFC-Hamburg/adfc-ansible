...
/usr/bin/smbclient -U Administrator -I 192.168.123.28 '\\Win7Pro_VM\C$' $(cat /etc/win7pro-admin.secret) -c 'cd adfc ; lcd /tmp/smbbackup; prompt; recurse; mget *; exit' >/dev/null 2>&1
if [ "$?" != "0" ]; then
