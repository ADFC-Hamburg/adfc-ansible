...
-- Create default user "guacadmin"
INSERT INTO guacamole_entity (name, type) VALUES ('guacadmin', 'USER');
INSERT INTO guacamole_user (entity_id, password_hash, password_salt, password_date)
SELECT
    entity_id,
    decode('6855D6B7FB5B81A613E8E301040D4BBB5FB4F0D14F3D20ACC0829AC8D7CC6FFB', 'hex'),
    decode('1717C360E66EF8826628C4386EC54BD276023D29026190055145795C37052D86', 'hex'),
    CURRENT_TIMESTAMP
